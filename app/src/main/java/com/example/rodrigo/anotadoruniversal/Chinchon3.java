...
public class Chinchon3 extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chinchon3_activity);
    ...
    public void alertPuntos(View vista){
        ...
        alertdialog.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                repartirPuntajes(puntaje1,puntaje2,puntaje3);
            }
        });
    ...
    public void repartirPuntajes (EditText puntaje1,EditText puntaje2,EditText puntaje3 ){
        if(!puntaje1.getText().toString().equals("")&&!puntaje2.getText().toString().equals("")&&!puntaje3.getText().toString().equals("")){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.Reiniciar){
            ...
            alertdialog.setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    Intent j = new Intent(Chinchon3.this,ConfiguracionChinchon.class);
